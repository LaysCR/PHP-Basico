...
;var qa=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};v("yt.config_",qa);function ra(a){var b=arguments;if(1<b.length)qa[b[0]]=b[1];else{var b=b[0],c;for(c in b)qa[c]=b[c]}}
...
sc.prototype.reset=function(){this.next=this.scope=this.b=null};function uc(a){var b=p("yt.logging.errors.log");b?b(a,void 0,void 0,void 0,void 0):(b=x("ERRORS",[]),b.push([a,void 0,void 0,void 0,void 0]),ra("ERRORS",b))}
function vc(a){return a&&window.yterr?function(){try{return a.apply(this,arguments)}catch(b){uc(b)}}:a}
;function L(a,b){ga(a)&&(a=vc(a));return window.setTimeout(a,b)}
...
;function Ac(a,b){Bc||Cc();Dc||(Bc(),Dc=!0);var c=Fc,d=tc.get();d.set(a,b);c.f?c.f.next=d:c.b=d;c.f=d}
...
var Dc=!1,Fc=new rc;function Gc(){for(var a;a=Fc.remove();){try{a.b.call(a.scope)}catch(b){wc(b)}mc(tc,a)}Dc=!1}
...
try{Gd[a]?g():L(g,0)}catch(h){uc(h)}}},c);
...
function Q(a,b){var c=Jd();return c?c.publish.apply(c,arguments):!1}
function Ld(a,b){Gd[a]=!0;var c=Jd();c&&c.publish.apply(c,arguments);Gd[a]=!1}
function Jd(){return p("yt.pubsub.instance_")}
;function Md(a,b,c,d,e,f,g){function h(){4==(l&&"readyState"in l?l.readyState:0)&&b&&vc(b)(l)}
...
new K("subscription-external-unsubscribe",ce),pe=new K("subscription-enable-ypc",Zd),qe=new K("subscription-disable-ypc",Zd),re=new K("subscription-prefs",$d),se=new K("subscription-prefs-success",$d),te=new K("subscription-prefs-failure",$d);function ue(a){this.type="";this.state=this.source=this.data=this.currentTarget=this.relatedTarget=this.target=null;this.charCode=this.keyCode=0;this.shiftKey=this.ctrlKey=this.altKey=!1;this.clientY=this.clientX=0;this.changedTouches=null;if(a=a||window.event){this.event=a;for(var b in a)b in ve||(this[b]=a[b]);(b=a.target||a.srcElement)&&3==b.nodeType&&(b=b.parentNode);this.target=b;if(b=a.relatedTarget)try{b=b.nodeName?b:null}catch(c){b=null}else"mouseover"==this.type?b=a.fromElement:"mouseout"==
...
ue.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};
var ve={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};function we(a,b,c,d){this.top=a;this.right=b;this.bottom=c;this.left=d}
we.prototype.getHeight=function(){return this.bottom-this.top};
we.prototype.ceil=function(){this.top=Math.ceil(this.top);this.right=Math.ceil(this.right);this.bottom=Math.ceil(this.bottom);this.left=Math.ceil(this.left);return this};
we.prototype.floor=function(){this.top=Math.floor(this.top);this.right=Math.floor(this.right);this.bottom=Math.floor(this.bottom);this.left=Math.floor(this.left);return this};
we.prototype.round=function(){this.top=Math.round(this.top);this.right=Math.round(this.right);this.bottom=Math.round(this.bottom);this.left=Math.round(this.left);return this};function xe(a,b,c,d){this.left=a;this.top=b;this.width=c;this.height=d}
xe.prototype.ceil=function(){this.left=Math.ceil(this.left);this.top=Math.ceil(this.top);this.width=Math.ceil(this.width);this.height=Math.ceil(this.height);return this};
xe.prototype.floor=function(){this.left=Math.floor(this.left);this.top=Math.floor(this.top);this.width=Math.floor(this.width);this.height=Math.floor(this.height);return this};
xe.prototype.round=function(){this.left=Math.round(this.left);this.top=Math.round(this.top);this.width=Math.round(this.width);this.height=Math.round(this.height);return this};function ye(a,b,c){if(r(b))(b=ze(a,b))&&(a.style[b]=c);else for(var d in b){c=a;var e=b[d],f=ze(c,d);f&&(c.style[f]=e)}}
var Ae={};function ze(a,b){var c=Ae[b];if(!c){var d=ya(b),c=d;void 0===a.style[d]&&(d=(xb?"Webkit":wb?"Moz":F?"ms":tb?"O":null)+za(d),void 0!==a.style[d]&&(c=d));Ae[b]=c}return c}
function Be(a,b){var c=Mb(a);return c.defaultView&&c.defaultView.getComputedStyle&&(c=c.defaultView.getComputedStyle(a,null))?c[b]||c.getPropertyValue(b)||"":""}
function Ce(a,b){return Be(a,b)||(a.currentStyle?a.currentStyle[b]:null)||a.style&&a.style[b]}
function De(a){var b;try{b=a.getBoundingClientRect()}catch(c){return{left:0,top:0,right:0,bottom:0}}F&&a.ownerDocument.body&&(a=a.ownerDocument,b.left-=a.documentElement.clientLeft+a.body.clientLeft,b.top-=a.documentElement.clientTop+a.body.clientTop);return b}
function Ee(a){if(F&&!(8<=Number(Gb)))return a.offsetParent;var b=Mb(a),c=Ce(a,"position"),d="fixed"==c||"absolute"==c;for(a=a.parentNode;a&&a!=b;a=a.parentNode)if(11==a.nodeType&&a.host&&(a=a.host),c=Ce(a,"position"),d=d&&"static"==c&&a!=b.documentElement&&a!=b.body,!d&&(a.scrollWidth>a.clientWidth||a.scrollHeight>a.clientHeight||"fixed"==c||"absolute"==c||"relative"==c))return a;return null}
function Fe(a){for(var b=new we(0,Infinity,Infinity,0),c=Kb(a),d=c.b.body,e=c.b.documentElement,f=Ub(c.b);a=Ee(a);)if(!(F&&0==a.clientWidth||xb&&0==a.clientHeight&&a==d)&&a!=d&&a!=e&&"visible"!=Ce(a,"overflow")){var g=Ge(a),h=new E(a.clientLeft,a.clientTop);g.j+=h.j;g.l+=h.l;b.top=Math.max(b.top,g.l);b.right=Math.min(b.right,g.j+a.clientWidth);b.bottom=Math.min(b.bottom,g.l+a.clientHeight);b.left=Math.max(b.left,g.j)}d=f.scrollLeft;f=f.scrollTop;b.left=Math.max(b.left,d);b.top=Math.max(b.top,f);c=
...
function Ge(a){var b=Mb(a),c=new E(0,0),d;d=b?Mb(b):document;d=!F||9<=Number(Gb)||Sb(Kb(d).b)?d.documentElement:d.body;if(a==d)return c;a=De(a);b=Tb(Kb(b).b);c.j=a.left+b.j;c.l=a.top+b.l;return c}
function He(a){a=De(a);return new E(a.left,a.top)}
function Ie(a,b){"number"==typeof a&&(a=(b?Math.round(a):a)+"px");return a}
function Je(a){var b=Ke;if("none"!=Ce(a,"display"))return b(a);var c=a.style,d=c.display,e=c.visibility,f=c.position;c.visibility="hidden";c.position="absolute";c.display="inline";a=b(a);c.display=d;c.position=f;c.visibility=e;return a}
function Ke(a){var b=a.offsetWidth,c=a.offsetHeight,d=xb&&!b&&!c;return aa(b)&&!d||!a.getBoundingClientRect?new pb(b,c):(a=De(a),new pb(a.right-a.left,a.bottom-a.top))}
function Le(a){var b=Ge(a);a=Je(a);return new xe(b.j,b.l,a.width,a.height)}
function Me(a){return"rtl"==Ce(a,"direction")}
...
var Pe={thin:2,medium:4,thick:6};function Qe(a,b){if("none"==(a.currentStyle?a.currentStyle[b+"Style"]:null))return 0;var c=a.currentStyle?a.currentStyle[b+"Width"]:null;return c in Pe?Pe[c]:Ne(a,c)}
;var Re=0;function Se(a){var b=a.__yt_uid_key;b||(b=Te(),a.__yt_uid_key=b);return b}
function Ue(a,b){a=G(a);b=G(b);return!!kc(a,function(a){return a===b},!0,void 0)}
function Ve(a,b){var c=Ob(a,null,b);return c.length?c[0]:null}
function We(){var a=document,b;Da(["fullscreenElement","webkitFullscreenElement","mozFullScreenElement","msFullscreenElement"],function(c){b=a[c];return!!b});
return b}
function Xe(){Ua(document.body,"hide-players",!1);y(Nb("preserve-players"),function(a){C(a,"preserve-players")})}
var Te=p("yt.dom.dom.getNextId_")||function(){return++Re};
v("yt.dom.dom.getNextId_",Te);var ab=p("yt.events.listeners_")||{};v("yt.events.listeners_",ab);var Ye=p("yt.events.counter_")||{count:0};v("yt.events.counter_",Ye);function Ze(a,b,c,d){a.addEventListener&&("mouseenter"!=b||"onmouseenter"in document?"mouseleave"!=b||"onmouseenter"in document?"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"):b="mouseout":b="mouseover");return $a(function(e){return e[0]==a&&e[1]==b&&e[2]==c&&e[4]==!!d})}
function S(a,b,c,d){if(!a||!a.addEventListener&&!a.attachEvent)return"";d=!!d;var e=Ze(a,b,c,d);if(e)return e;var e=++Ye.count+"",f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document),g;g=f?function(d){d=new ue(d);if(!kc(d.relatedTarget,function(b){return b==a},!0))return d.currentTarget=a,d.type=b,c.call(a,d)}:function(b){b=new ue(b);
b.currentTarget=a;return c.call(a,b)};
g=vc(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),a.addEventListener(b,g,d)):a.attachEvent("on"+b,g);ab[e]=[a,b,c,g,d];return e}
function $e(a,b,c){return af(a,b,function(a){return z(a,c)})}
function af(a,b,c){var d=a||document;return S(d,"click",function(a){var e=kc(a.target,function(a){return a===d||c(a)},!0);
...
function cf(a){if(document.createEvent){var b=document.createEvent("HTMLEvents");b.initEvent("click",!0,!0);a.dispatchEvent(b)}else b=document.createEventObject(),a.fireEvent("onclick",b)}
;function df(a,b){(a=G(a))&&a.style&&(a.style.display=b?"":"none",Ua(a,"hid",!b))}
function ef(a){return(a=G(a))?"none"!=a.style.display&&!z(a,"hid"):!1}
function ff(a){y(arguments,function(a){!ea(a)||a instanceof Element?df(a,!0):y(a,function(a){ff(a)})})}
function gf(a){y(arguments,function(a){!ea(a)||a instanceof Element?df(a,!1):y(a,function(a){gf(a)})})}
;function hf(){var a=We();return a?a:null}
;function jf(a,b,c,d,e,f,g){var h,l;if(h=c.offsetParent){var n="HTML"==h.tagName||"BODY"==h.tagName;n&&"static"==Ce(h,"position")||(l=Ge(h),n||(n=(n=Me(h))&&wb?-h.scrollLeft:!n||vb&&Fb("8")||"visible"==Ce(h,"overflowX")?h.scrollLeft:h.scrollWidth-h.clientWidth-h.scrollLeft,l=ob(l,new E(n,h.scrollTop))))}h=l||new E;l=Le(a);if(n=Fe(a)){var q=new xe(n.left,n.top,n.right-n.left,n.bottom-n.top),n=Math.max(l.left,q.left),N=Math.min(l.left+l.width,q.left+q.width);if(n<=N){var R=Math.max(l.top,q.top),q=Math.min(l.top+
l.height,q.top+q.height);R<=q&&(l.left=n,l.top=R,l.width=N-n,l.height=q-R)}}n=Kb(a);R=Kb(c);if(n.b!=R.b){var N=n.b.body,A;var R=Vb(R.b),q=new E(0,0),u;u=(u=Mb(N))?Vb(u):window;b:{try{qb(u.parent);A=!0;break b}catch(Ec){}A=!1}if(A){A=N;do{var la=u==R?Ge(A):He(A);q.j+=la.j;q.l+=la.l}while(u&&u!=R&&u!=u.parent&&(A=u.frameElement)&&(u=u.parent))}A=ob(q,Ge(N));!F||9<=Number(Gb)||Sb(n.b)||(A=ob(A,Tb(n.b)));l.left+=A.j;l.top+=A.l}a=kf(a,b);b=l.left;a&4?b+=l.width:a&2&&(b+=l.width/2);b=new E(b,l.top+(a&1?
l.height:0));b=ob(b,h);e&&(b.j+=(a&4?-1:1)*e.j,b.l+=(a&1?-1:1)*e.l);var T;g&&(T=Fe(c))&&(T.top-=h.l,T.right-=h.j,T.bottom-=h.l,T.left-=h.j);return lf(b,c,d,f,T,g,void 0)}
function lf(a,b,c,d,e,f,g){a=new E(a.j,a.l);var h=kf(b,c);c=Je(b);g=g?new pb(g.width,g.height):new pb(c.width,c.height);a=new E(a.j,a.l);g=new pb(g.width,g.height);var l=0;if(d||0!=h)h&4?a.j-=g.width+(d?d.right:0):h&2?a.j-=g.width/2:d&&(a.j+=d.left),h&1?a.l-=g.height+(d?d.bottom:0):d&&(a.l+=d.top);if(f){if(e){d=a;h=g;l=0;65==(f&65)&&(d.j<e.left||d.j>=e.right)&&(f&=-2);132==(f&132)&&(d.l<e.top||d.l>=e.bottom)&&(f&=-5);d.j<e.left&&f&1&&(d.j=e.left,l|=1);if(f&16){var n=d.j;d.j<e.left&&(d.j=e.left,l|=
...
e.top?64:0)|(d.l+h.height>e.bottom?128:0));e=l}else e=256;l=e}f=new xe(0,0,0,0);f.left=a.j;f.top=a.l;f.width=g.width;f.height=g.height;e=l;if(e&496)return e;g=new E(f.left,f.top);g instanceof E?(a=g.j,g=g.l):(a=g,g=void 0);b.style.left=Ie(a,!1);b.style.top=Ie(g,!1);g=new pb(f.width,f.height);c==g||c&&g&&c.width==g.width&&c.height==g.height||(c=g,g=Sb(Kb(Mb(b)).b),!F||Fb("10")||g&&Fb("8")?(b=b.style,wb?b.MozBoxSizing="border-box":xb?b.WebkitBoxSizing="border-box":b.boxSizing="border-box",b.width=Math.max(c.width,
0)+"px",b.height=Math.max(c.height,0)+"px"):(a=b.style,g?(F?(g=Oe(b,"paddingLeft"),f=Oe(b,"paddingRight"),d=Oe(b,"paddingTop"),h=Oe(b,"paddingBottom"),g=new we(d,f,h,g)):(g=Be(b,"paddingLeft"),f=Be(b,"paddingRight"),d=Be(b,"paddingTop"),h=Be(b,"paddingBottom"),g=new we(parseFloat(d),parseFloat(f),parseFloat(h),parseFloat(g))),!F||9<=Number(Gb)?(f=Be(b,"borderLeftWidth"),d=Be(b,"borderRightWidth"),h=Be(b,"borderTopWidth"),b=Be(b,"borderBottomWidth"),b=new we(parseFloat(h),parseFloat(d),parseFloat(b),
parseFloat(f))):(f=Qe(b,"borderLeft"),d=Qe(b,"borderRight"),h=Qe(b,"borderTop"),b=Qe(b,"borderBottom"),b=new we(h,d,b,f)),a.pixelWidth=c.width-b.left-g.left-g.right-b.right,a.pixelHeight=c.height-b.top-g.top-g.bottom-b.bottom):(a.pixelWidth=c.width,a.pixelHeight=c.height)));return e}
function kf(a,b){return(b&8&&Me(a)?b^4:b)&-9}
;function mf(){}
;function nf(){}
...
function Ef(a,b,c,d,e){var f=ef(c),g=9==d.keyCode;if(g||32==d.keyCode||13==d.keyCode)if(d=Gf(a,c)){if(aa(d.firstElementChild))b=d.firstElementChild;else for(b=d.firstChild;b&&1!=b.nodeType;)b=b.nextSibling;a=b;if("a"==a.tagName.toLowerCase()){var h,l;h=void 0===h?{}:h;l=void 0===l?"":l;b=window.location;h=ad(dd([a.href],h))+l;h instanceof gb||h instanceof gb||(h=h.va?h.ra():String(h),ib.test(h)||(h="about:invalid#zClosurez"),h=jb(h));h instanceof gb&&h.constructor===gb&&h.f===hb?h=h.b:(da(h),h="type_error:SafeUrl");
b.href=h}else cf(a)}else g&&Hf(a,b);else f?27==d.keyCode?(Gf(a,c),Hf(a,b)):e(b,c,d):(h=z(b,V(a,"reverse"))?38:40,d.keyCode==h&&(cf(b),d.preventDefault()))}
k.xa=function(a,b,c){c.altKey||c.ctrlKey||c.shiftKey||(a=Df(this,a),ef(a)&&c.preventDefault())};
...
k.tb=function(a,b,c){var d=Gf(this,b);if(d){var e=Ve("table",b);b=Ob("td",null,e);d=Jf(d,b,Ob("td",null,Ve("tr",e)).length,c);-1!=d&&(If(this,a,b[d]),c.preventDefault())}};
k.ub=function(a,b,c){if(40==c.keyCode||38==c.keyCode){var d=Gf(this,b);d&&(b=Ba(Ob("li",null,b),ef),If(this,a,b[Jf(d,b,1,c)]),c.preventDefault())}};
...
function Kf(a,b){var c=b.iframeMask;c||(c=document.createElement("iframe"),c.src='javascript:""',c.className=V(a,"menu-mask"),gf(c),b.iframeMask=c);return c}
function Ff(a,b,c,d){var e=I(b,V(a,"group")),f=!!a.g(b,"button-menu-ignore-group"),e=e&&!f?e:b,f=9,g=8,h=Le(b);if(z(b,V(a,"reverse"))){f=8;g=9;h=h.top+"px";try{c.style.maxHeight=h}catch(q){}}z(b,"flip")&&(z(b,V(a,"reverse"))?(f=12,g=13):(f=13,g=12));var l;a.g(b,"button-has-sibling-menu")?l=Ee(e):a.g(b,"button-menu-root-container")&&(l=Lf(a,b));F&&!Fb("8")&&(l=null);var n;l&&(n=Le(l),n=new we(-n.top,n.left,n.top,-n.left));l=new E(0,1);z(b,V(a,"center-menu"))&&(l.j-=Math.round((Je(c).width-Je(b).width)/
2));d&&(l.l+=Tb(document).l);if(a=Kf(a,b))b=Je(c),a.style.width=b.width+"px",a.style.height=b.height+"px",jf(e,f,a,g,l,n,197),d&&ye(a,"position","fixed");jf(e,f,c,g,l,n,197)}
...
k.Oa=function(a){if(a){var b=Df(this,a);if(b){a.setAttribute("aria-pressed","true");a.setAttribute("aria-expanded","true");b.originalParentNode=b.parentNode;b.activeButtonNode=a;b.parentNode.removeChild(b);var c;this.g(a,"button-has-sibling-menu")?c=a.parentNode:c=Lf(this,a);c.appendChild(b);b.style.minWidth=a.offsetWidth-2+"px";var d=Kf(this,a);d&&c.appendChild(d);(c=!!this.g(a,"button-menu-fixed"))&&(this.f[Se(a).toString()]=b);Ff(this,a,b,c);Ld("yt-uix-button-menu-before-show",a,b);ff(b);d&&ff(d);
this.O(a,"button-menu-action",!0);B(a,V(this,"active"));b=t(this.Na,this,a,!1);d=t(this.Na,this,a,!0);c=t(this.Fb,this,a,void 0);this.b&&Df(this,this.b)==Df(this,a)||Bf(this);Q("yt-uix-button-menu-show",a);U(this.i);this.i=[S(document,"click",d),S(document,"contextmenu",b),S(window,"resize",c)];this.b=a}}};
function Hf(a,b){if(b){var c=Df(a,b);if(c){a.b=null;b.setAttribute("aria-pressed","false");b.setAttribute("aria-expanded","false");b.removeAttribute("aria-activedescendant");gf(c);a.O(b,"button-menu-action",!1);var d=Kf(a,b),e=Se(c).toString();delete a.f[e];L(function(){d&&d.parentNode&&(gf(d),d.parentNode.removeChild(d));c.originalParentNode&&(c.parentNode.removeChild(c),c.originalParentNode.appendChild(c),c.originalParentNode=null,c.activeButtonNode=null)},1)}var e=I(b,V(a,"group")),f=[V(a,"active")];
e&&f.push(V(a,"group-active"));Ta(b,f);Q("yt-uix-button-menu-hide",b);U(a.i);a.i.length=0}}
...
k.Na=function(a,b,c){c=bf(c);var d=I(c,V(this));if(d){var d=Df(this,d),e=Df(this,a);if(d==e)return}var d=I(c,V(this,"menu")),e=d==Df(this,a),f=z(c,V(this,"menu-item")),g=z(c,V(this,"menu-close"));if(!d||e&&(f||g))Hf(this,a),d&&b&&this.g(a,"button-menu-indicate-selected")&&((a=H(V(this,"content"),a))&&$b(a,hc(c)),Mf(this,d,c))};
...
k.click=function(a){if(Df(this,a)){var b=Df(this,a);if(b){var c=I(b.activeButtonNode||b.parentNode,V(this));c&&c!=a?(Hf(this,c),L(t(this.Oa,this,a),1)):ef(b)?Hf(this,a):this.Oa(a)}a.focus()}this.O(a,"button-action")};
...
k.show=function(a){var b=this.C(a);if(b){B(b,V(this,"active"));var c=Pf(this,a,b);if(c){c.cardTargetNode=a;c.cardRootNode=b;Qf(this,a,c);var d=V(this,"card-visible"),e=this.g(a,"card-delegate-show")&&this.g(b,"card-action");this.O(b,"card-action",a);this.i=a;gf(c);L(t(function(){e||(ff(c),Q("yt-uix-card-show",b,a,c));Rf(c);B(c,d);Q("yt-uix-kbd-nav-move-in-to",c)},this),10)}}};
function Pf(a,b,c){var d=c||b,e=V(a,"card");c=Sf(a,d);var f=G(V(a,"card")+Se(d));if(f)return a=H(V(a,"card-body"),f),Zb(a,c)||(Wb(c),a.appendChild(c)),f;f=document.createElement("div");f.id=V(a,"card")+Se(d);f.className=e;(d=a.g(d,"card-class"))&&Sa(f,d.split(/\s+/));d=document.createElement("div");d.className=V(a,"card-border");b=a.g(b,"orientation")||"horizontal";e=document.createElement("div");e.className="yt-uix-card-border-arrow yt-uix-card-border-arrow-"+b;var g=document.createElement("div");
...
function Qf(a,b,c){var d=a.g(b,"orientation")||"horizontal",e=H(V(a,"anchor"),b)||b,f=a.g(b,"position"),g=!!a.g(b,"force-position"),h=a.g(b,"position-fixed"),d="horizontal"==d,l="bottomright"==f||"bottomleft"==f,n="topright"==f||"bottomright"==f,q,N;n&&l?(N=13,q=8):n&&!l?(N=12,q=9):!n&&l?(N=9,q=12):(N=8,q=13);var R=Me(document.body),f=Me(b);R!=f&&(N^=4);var A;d?(f=b.offsetHeight/2-12,A=new E(-12,b.offsetHeight+6)):(f=b.offsetWidth/2-6,A=new E(b.offsetWidth+6,-12));var u=Je(c),f=Math.min(f,(d?u.height:
u.width)-24-6);6>f&&(f=6,d?A.l+=12-b.offsetHeight/2:A.j+=12-b.offsetWidth/2);u=null;g||(u=10);b=V(a,"card-flip");a=V(a,"card-reverse");Ua(c,b,n);Ua(c,a,l);u=jf(e,N,c,q,A,null,u);!g&&u&&(u&48&&(n=!n,N^=4,q^=4),u&192&&(l=!l,N^=1,q^=1),Ua(c,b,n),Ua(c,a,l),jf(e,N,c,q,A));h&&(e=parseInt(c.style.top,10),g=Tb(document).l,ye(c,"position","fixed"),ye(c,"top",e-g+"px"));R&&(c.style.right="",e=Le(c),e.left=e.left||parseInt(c.style.left,10),g=Rb(window),c.style.left="",c.style.right=g.width-e.left-e.width+"px");
e=H("yt-uix-card-body-arrow",c);g=H("yt-uix-card-border-arrow",c);d=d?l?"top":"bottom":!R&&n||R&&!n?"left":"right";e.setAttribute("style","");g.setAttribute("style","");e.style[d]=f+"px";g.style[d]=f+"px";l=H("yt-uix-card-arrow",c);n=H("yt-uix-card-arrow-background",c);l&&n&&(c="right"==d?Je(c).width-f-13:f+11,f=c/Math.sqrt(2),l.style.left=c+"px",l.style.marginLeft="1px",n.style.marginLeft=-f+"px",n.style.marginTop=f+"px")}
k.H=function(a){if(a=this.C(a)){var b=G(V(this,"card")+Se(a));b&&(C(a,V(this,"active")),C(b,V(this,"card-visible")),gf(b),this.i=null,b.cardTargetNode=null,b.cardRootNode=null,b.cardMask&&(Wb(b.cardMask),b.cardMask=null))}};
function Of(a){a.i&&a.H(a.i)}
k.Eb=function(a,b){var c=this.C(a);if(c){if(b){var d=Sf(this,c);if(!d)return;b instanceof kb?d.innerHTML=mb(b):$b(d,b)}z(c,V(this,"active"))&&(c=Pf(this,a,c),Qf(this,a,c),ff(c),Rf(c))}};
...
return Ba(Ca(a,function(a){return ef(a)?ac(a,function(a){return Yb(a)?ec(a):!1}):!1}),function(a){return!!a})}
...
k.sa=function(a,b,c){a&&(b=cg(this,a),!b.disabled&&Ue(c.target,b)&&dg(this,a))};
k.lb=function(a,b,c){a&&z(a,V(this,"hover"))&&Ue(c.target,cg(this,a))&&dg(this,a,!0)};
k.ob=function(){this.b&&this.f&&eg(this,this.f,this.b)};
function eg(a,b,c){var d=fg(a,b);if(d){var e=Je(c),f;if(e instanceof pb)f=e.height,e=e.width;else throw Error("missing height argument");d.style.width=Ie(e,!0);d.style.height=Ie(f,!0)}c==a.b&&(e=9,f=8,z(b,V(a,"reversed"))&&(e^=1,f^=1),z(b,V(a,"flipped"))&&(e^=4,f^=4),a=new E(0,1),d&&jf(b,e,d,f,a,null,197),jf(b,e,c,f,a,null,197))}
function dg(a,b,c){gg(a,b)&&!c?bg(a,b):(hg(a,b),!a.b||Ue(b,a.b)?a.Pa(b):Hc(a.o,t(a.Pa,a,b)))}
k.Pa=function(a){if(a){var b=ig(this,a);if(b){Ld("yt-uix-menu-before-show",a,b);this.b?Ue(a,this.b)||bg(this,this.f):(this.f=a,this.b=b,z(a,V(this,"sibling-content"))||(Wb(b),document.body.appendChild(b)),b.style.minWidth=cg(this,a).offsetWidth-2+"px");var c=fg(this,a);c&&b.parentNode&&b.parentNode.insertBefore(c,b.nextSibling);C(b,V(this,"content-hidden"));eg(this,a,b);Sa(cg(this,a),[V(this,"trigger-selected"),"yt-uix-button-toggled"]);Q("yt-uix-menu-show",a);jg(b);kg(this,a);Q("yt-uix-kbd-nav-move-in-to",
...
k.mb=function(a,b){var c=bf(b);c&&(Ue(c,cg(this,a))||lg(this,c)||mg(this,a))};
k.Gb=function(a,b){var c=bf(b);if(c){if(lg(this,c)){var d=I(c,V(this,"content")),e=jc(c,"LI");e&&d&&Zb(d,e)&&Ld("yt-uix-menu-item-clicked",c);c=I(c,V(this,"close-on-select"));if(!c)return;d=ag(c)}bg(this,d||a)}};
function hg(a,b){if(b){var c=I(b,V(a,"content"));c&&y(Nb(V(a),c),function(a){!Ue(a,b)&&gg(this,a)&&mg(this,a)},a)}}
function bg(a,b){if(b){var c=[];c.push(b);var d=ig(a,b);d&&(d=Nb(V(a),d),d=Ha(d),c=c.concat(d),y(c,function(a){gg(this,a)&&mg(this,a)},a))}}
function mg(a,b){if(b){var c=ig(a,b);Ta(cg(a,b),[V(a,"trigger-selected"),"yt-uix-button-toggled"]);B(c,V(a,"content-hidden"));var d=ig(a,b);d&&Pb(d,{"aria-expanded":"false"});(d=fg(a,b))&&d.parentNode&&Wb(d);c&&c==a.b&&(a.f.appendChild(c),a.b=null,a.f=null,a.o&&a.o.J("ROOT_MENU_REMOVED"));Q("yt-uix-menu-hide",b);c=ia(b).toString();U(a.i[c]);delete a.i[c]}}
k.rb=function(a,b){var c=bf(b);c&&ng(this,a,c)};
k.sb=function(a,b){var c=bf(b);if(c){var d=cg(this,a);if(d&&(c=jc(c,"LI")))if(c=hc(c).trim(),d.hasChildNodes()){var e=Af.A();(d=H(V(e,"content"),d))&&$b(d,c)}else $b(d,c)}};
...
function lg(a,b){return Ue(b,a.b)||Ue(b,a.f)}
...
e=a.offsetHeight);a=c>b?c>e?c:e:c<e?c:e}else a=0}this.f.style.height=a+"px";ff(this.f)}this.ua();a=vg(this);wg(a);this.v=S(document,"keydown",t(this.qb,this));a=this.b;d=Id("player-added",this.ua,this);Tc(a,"player-ready-pubsub-key",d);this.ab&&(this.w=S(document,"click",t(this.Ab,this)));ff(this.b);this.i.setAttribute("tabindex","0");xg(this);this.K||B(document.body,"yt-dialog-active");Bf(Af.A());Of(og.A());Of(pg.A());Q("yt-ui-dialog-show-complete",this)}};
function yg(){return Da(Nb("yt-dialog"),function(a){return ef(a)})}
...
k.dismiss=function(a){if(!this.W()){this.o.J("pre-all");this.o.J("pre-"+a);gf(this.b);Of(og.A());Of(pg.A());this.i.setAttribute("tabindex","-1");yg()||(gf(this.f),this.K||C(document.body,"yt-dialog-active"),Xe(),zg());this.v&&(U(this.v),this.v=null);this.w&&(U(this.w),this.w=null);var b=this.b;if(b){var c=Vc(b,"player-ready-pubsub-key");c&&(Kd(c),Wc(b,"player-ready-pubsub-key"))}this.o.J("post-all");Q("yt-ui-dialog-hide-complete",this);"cancel"==a&&Q("yt-ui-dialog-cancelled",this);this.o&&this.o.J("post-"+
...
k.dispose=function(){ef(this.b)&&this.dismiss("dispose");U(this.F);this.F.length=0;L(t(function(){this.B=null},this),0);
...
function Fg(){var a=Ag.A();if(a.i)a=H("yt-dialog-fg-content",a.i.overlayContentNode);else a:{if(a=Nb("yt-dialog-fg-content"))for(var b=0;b<a.length;b++){var c=I(a[b],"yt-dialog");if(ef(c)){a=a[b];break a}}a=null}return a}
k.Qa=function(a){a&&a.disabled||Q("yt-uix-overlay-hide")};
function Eg(){Dg(Ag.A())}
...
function Jg(a,b){U(Hg);Hg.length=0;Gg[b]||(Gg[b]=Ig(a));Ag.A().show(Gg[b]);var c=Fg();return new nd(function(a){Hg.push($e(c,function(){a()},"overlay-confirmation-unsubscribe-button"))})}
...
v("yt.pubsub.publish",Q);function Lg(){var a=x("PLAYER_CONFIG");return a&&a.args&&void 0!==a.args.authuser?!0:!(!x("SESSION_INDEX")&&!x("LOGGED_IN"))}
...
var n=hc(b),l=Pg(a,b,"arialabel"),f=document.createElement("div");B(f,V(a,"arialabel"));f.id=l;n=b.hasAttribute("aria-label")?b.getAttribute("aria-label"):"rtl"==document.body.getAttribute("dir")?c+" "+n:n+" "+c;$b(f,n);b.setAttribute("aria-labelledby",l);l=hf()||document.body;l.appendChild(f);l.appendChild(d);Rg(a,b,c);(c=parseInt(a.g(b,"tooltip-max-width"),10))&&e.offsetWidth>c&&(e.style.width=c+"px",B(g,V(a,"normal-wrap")));g=z(b,V(a,"reverse"));Tg(a,b,d,e,h,g)||Tg(a,b,d,e,h,!g);var q=V(a,"tip-visible");
L(function(){B(d,q)},0)}}}}
function Tg(a,b,c,d,e,f){Ua(c,V(a,"tip-reverse"),f);var g=0;f&&(g=1);var h=Je(b);f=new E((h.width-10)/2,f?h.height:0);var l=Ge(b);lf(new E(l.j+f.j,l.l+f.l),c,g);f=Rb(window);var n;1==c.nodeType?n=He(c):(c=c.changedTouches?c.changedTouches[0]:c,n=new E(c.clientX,c.clientY));c=Je(d);var q=Math.floor(c.width/2),g=!!(f.height<n.l+h.height),h=!!(n.l<h.height),l=!!(n.j<q);f=!!(f.width<n.j+q);n=(c.width+3)/-2- -5;a=a.g(b,"force-tooltip-direction");if("left"==a||l)n=-5;else if("right"==a||f)n=20-c.width-
3;a=Math.floor(n)+"px";d.style.left=a;e&&(e.style.left=a,e.style.height=c.height+"px",e.style.width=c.width+"px");return!(g||h)}
function Pg(a,b,c){a=V(a)+Se(b);c&&(a+="-"+c);return a}
function Sg(a,b){var c=null;yb&&z(b,V(a,"masked"))&&((c=G("yt-uix-tooltip-shared-mask"))?(c.parentNode.removeChild(c),ff(c)):(c=document.createElement("iframe"),c.src='javascript:""',c.id="yt-uix-tooltip-shared-mask",c.className=V(a,"tip-mask")));return c}
function Qg(a){var b=G("yt-uix-tooltip-shared-mask"),c=b&&kc(b,function(b){return b==a},!1,2);
b&&c&&(b.parentNode.removeChild(b),gf(b),document.body.appendChild(b))}
...
function Sh(a,b){var c=b||{};"function"==typeof b&&(c={},c.callback=b);Ph(a,c);var d=a?a.split(":"):[],e=c.h||Ih(),f=Y(Z,"ah",jh());if(f["::"]&&d.length){for(var g=[],h=null;h=d.shift();){var l=h.split("."),l=f[h]||f[l[1]&&"ns:"+l[0]||""]||e,n=g.length&&g[g.length-1]||null,q=n;n&&n.hint==l||(q={hint:l,features:[]},g.push(q));q.features.push(h)}var N=g.length;if(1<N){var R=c.callback;R&&(c.callback=function(){0==--N&&R()})}for(;d=g.shift();)Th(d.features,c,d.hint)}else Th(d||[],c,e)}
function Th(a,b,c){function d(a,b){if(N)return 0;ch.clearTimeout(q);R.push.apply(R,u);var d=((kh||{}).config||{}).update;d?d(f):f&&Y(Z,"cu",[]).push(f);if(b){qh("me0",a,A);try{Qh(b,c,n)}finally{qh("me1",a,A)}}return 1}
a=ih(a)||[];var e=b.callback,f=b.config,g=b.timeout,h=b.ontimeout,l=b.onerror,n=void 0;"function"==typeof l&&(n=l);var q=null,N=!1;if(g&&!h||!g&&h)throw"Timeout requires both the timeout parameter and ontimeout parameter to be set";var l=Y(nh(c),"r",[]).sort(),R=Y(nh(c),"L",[]).sort(),A=[].concat(l);0<g&&(q=ch.setTimeout(function(){N=!0;h()},g));
var u=Lh(a,R);if(u.length){var u=Lh(a,l),la=Y(Z,"CP",[]),T=la.length;la[T]=function(a){function b(){var a=la[T+1];a&&a()}
function c(b){la[T]=null;d(u,a)&&mh(function(){e&&e();b()})}
if(!a)return 0;qh("ml1",u,A);0<T&&la[T-1]?la[T]=function(){c(b)}:c(b)};
if(u.length){var Ec="loaded_"+Z.I++;kh[Ec]=function(a){la[T](a);kh[Ec]=null};
a=Ah(c,u,"gapi."+Ec,l);l.push.apply(l,u);qh("ml0",u,A);b.sync||ch.___gapisync?Nh(a):Oh(a)}else la[T](fh)}else d(u)&&e&&e()}
...
;function oi(){Uh(function(){var a;a=Je(G("yt-subscribe"));a={width:a.width,height:a.height};var b=pi;Vh().ready(a,null,b)})}
...
function Gi(a,b,c,d){var e=new Zd(a);O(ge,e);var f={};f.c=a;c&&(f.eurl=c);d&&(f.source=d);c={};(d=x("PLAYBACK_ID"))&&(c.plid=d);(d=x("EVENT_ID"))&&(c.ei=d);b&&Ti(b,c);Qd("/subscription_ajax?action_create_subscription_to_channel=1",{method:"POST",Ka:f,M:c,P:function(b,c){var d=c.response;O(ie,new be(a,d.id,d.channel_info));d.show_feed_privacy_dialog&&Q("SHOW-FEED-PRIVACY-SUBSCRIBE-DIALOG",a);d.actions&&ri(d.actions)},
ca:function(){O(he,e)}})}
...
;v("yt.setConfig",ra);v("yt.config.set",ra);v("ytbin.www.subscribeembed.init",function(){Di=!0;Ei.push(P(fe,Fi),P(ke,Hi));Di||Ei.push(P(je,Fi),P(oe,Hi),P(de,Ji),P(ee,Li),P(re,Ni),P(zi,Pi),P(Bi,Ri),P(yi,Qi));var a=Ug.A(),b=V(a);b in bh||(a.register(),xf(a,"yt-uix-init-"+b,a.init),xf(a,"yt-uix-dispose-"+b,a.dispose),bh[b]=a);oi()});}).call(this);
